...
<div class="container">
	<div class="row header text-center specials">
		<div class="h_logo">
			<a href="index.php"><img src="images/logo.gif" alt="" class="responsive"/></a>
		</div>
		<nav class="top-nav">
			<ul class="top-nav nav_list">
				...
				<li><a href="complaint_choice.html">Register Complaint</a></li>
			</ul>
				   ...
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				  	 	<div class="slider_img text-center">
				   			<ul class="list-unstyled list_imgs">
				   				<li><img src="images/nitk.jpg" alt="" class="responsive"/></li>
				   			</ul>
			           	</div>
				   </article>
	...
	<div class="container">
		<div class="row  footer">
			<div class="copy text-center">
				<p class="link"><span>NITK Surathkal</a></span></p>
